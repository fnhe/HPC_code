...
while(<IN>){
	...
	# strelka
        ...
        print OUT "$fout/strelka/manta/runWorkflow.py -j 4 -g 4 >>$fout/strelka_run.log 2>&1\n";
        ...
        print OUT "$fout/strelka/runWorkflow.py -m local -j 4 -g 4 >>$fout/strelka_run.log 2>&1\n";
