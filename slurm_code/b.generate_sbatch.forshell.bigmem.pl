...
print "module load miniconda3/4.10.3 htslib/1.14 bcftools/1.14 fastqc/0.11.9 bwa/0.7.17 gatk/4.2.3.0 samtools/1.14 kallisto/0.46.0 trim_galore/0.6.7 somaticwrapper/1.5 germlinewrapper/1.0\n";
